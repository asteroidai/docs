---
title: Introduction
description: 'Documentation for Asteroid, the supervision and evaluation platform for agentic systems.'
---

The Asteroid Platform is a supervision and evaluation platform for LLM-based systems built by [Asteroid](http://asteroid.ai/). Asteroid allows you to supervise and evaluate agentic systems during experimentation to quickly iterate on your agent architecture. In production, Asteroid's supervisors can continue to monitor your agent and intervene to correct the agent's actions, terminate the agent or escalate an action to a human reviewer. 
