  ...
  <Card title="Chain 1 - Check Email Domains and Content">
    <Steps>
      <Step title="Check Email Domains Supervisor">
        Deterministic Supervisor that only allows emails to be sent to whitelisted domains: `['my-company.com', 'asteroid.sh']`
      </Step>
