  ...
  <Accordion icon="rectangle-terminal" title="Using Inspect">
    <Steps>
      ...
      <Step title="Run the example">
        ...
        ```
        This will run the example and trigger approvals. View them at `http://localhost:3000`.
      </Step>
    </Steps>
    <Info>
      For more details on the Inspect example, refer to the [example README](https://github.com/EntropyLabsAI/sentinel/tree/main/examples/inspect_example).
    </Info>
  </Accordion>
</AccordionGroup>
