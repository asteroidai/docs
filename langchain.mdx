---
title: LangChain
description: Using Entropy Labs Supervision and Mocking with LangChain
---

# Using Entropy Labs Supervision and Mocking with LangChain

This documentation provides an overview of how to use Entropy Labs' supervision and mocking tools with LangChain to build intelligent agents. By integrating supervision functions, mock policies, and the `@supervise` decorator, you can create robust AI applications that are both controllable and testable.

## Introduction

Entropy Labs extends LangChain by introducing supervision and mocking capabilities, allowing developers to:
